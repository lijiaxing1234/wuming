...
<form:form id="inputForm" action="${ctx}/examinationHomeWork/selectKnowledge"  method="post" class="form-horizontal">
    <input name="exam.id" type="hidden" value="${examination.id}">
    <input name="courseKnowledge.id" type="hidden" id="ckIds" value="${examknowledgesIds}">
   	<div class="control-group">
		<label class="control-label"></label>
		<div class="controls">
			<input  type="radio" maxlength="50" class="required" name="exam.examMode"    ${examination.examMode eq '1' ? 'checked="checked"' :'' } value="1"  id="examTypeManual" />手动出题
			<input  type="radio" maxlength="50" class="required" name="exam.examMode"    ${examination.examMode eq '0' ? 'checked="checked"' :'' }  value="0"  id="examTypeAuto"  />自动出题
		</div>
	</div>
