...
<body>
    ...
    <form:form id="searchForm" modelAttribute="question" action="${ctx}/exerciseExamination/selectQuestion" method="post" class="breadcrumb form-search ">
	...
	<form:form id="listForm" modelAttribute="TeacherVersionQuestion" action="" method="post" class="form-horizontal">
	 ...
	 <div id="content" style="border: 1px solid #e5e5e5;padding: 20px 10px; margin-top: 20px; ">
	    <ol id="content-ol">
	 ...
	 function selectAll(){
	    	...
	    	if(obj.length){
		    	for(i=0;i<obj.length;i++){
		    		...
		    		var knowId=$("#teacherQuestionId").val();
		    		if(value){
		    			if(questionIds==null){
	    ...
	    (function(){
	    	$("#treeTable tbody tr").click(function(){
	    		...
	    		$(this).children.first.checked=true; */
	    	...
	    	/*  $("#treeTable :input[type=checkbox]").each(function(){
				$(this).click(function(){
					var id = $(this).val(), 
	    ...
	    (function(){
	    	/* var v=parent.questionIds;
			$("#searchForm").append(v); */
			var value=parent.$("#questionIds").val();
			var questionAndKnows=value.split(",");
	    	...
	    	if(obj.length){
		    	for(i=0;i<obj.length;i++){
		    		...
		    		if(questionAndKnows){
		    			for(j=0;j<questionAndKnows.length;j++){
		    				var q=questionAndKnows[j]
		    		...
		    		/* questionAndKnows.each(function(){
		    			var question=$(this).split(":")[0];
		    			var know=$(this).split(":")[1];
						if(questionId==question){
		    				obj[i].checked=true;
		    			}
					}); */
