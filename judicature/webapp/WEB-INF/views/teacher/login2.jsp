...
<head>
	...
	<script type="text/javascript" src="${ctxStatic }/modules/teacher/login/js/jquery-1.7.2.min.js"></script>
	...
	<script src="${ctxStatic}/modules/teacher/js/main.js" type="text/javascript"></script>
	
	
	<link rel='stylesheet' type='text/css' charset='utf-8'  href='${ctxStatic }/modules/teacher/login/css/jquery-impromptu.css' />
	<link rel='stylesheet' type='text/css' charset='utf-8'  href='${ctxStatic }/modules/teacher/login/css/demo.css' />
	
	<script type="text/javascript" src="${ctxStatic }/modules/teacher/login/js/common.js"></script>
	
    <script  type='text/javascript' src='${ctxStatic }/modules/teacher/login/js/template.js' charset='utf-8'></script>
    <script  type='text/javascript' src='${ctxStatic }/modules/teacher/login/js/jquery.flexslider.js' charset='utf-8'></script>
	<!--[if IE 6]>
	  <script  type='text/javascript' src='${ctxStatic }/modules/teacher/login/js/DD_belatedPNG.js' charset='utf-8'></script> 
...
<div class="zy-header JS-indexPageBox">
    <div class="zy-inner">
       ...
       <!--  <div class="rightIn">
            <a href="http://www.17zuoye.com/help/downloadApp.vpage?refrerer=pc" target="_blank" class="load"><i class="phone-icon"></i>APP下载</a>
        </div> -->
    </div>
</div>
    ...
    <div class="JS-indexSwitch-main">
        <ul class="zy-homeBox slides">
            <li class="homeItem homeItem02">
                <div class="innerBox">
                    <div class="info">
                        ...
                        <div class="title01" style="font-size: 64px">在线考试-自动阅卷</div>
            ...
            <li class="homeItem homeItem03" >
                <div class="innerBox">
                    <%-- <div class="info">
                            ...
                            <div class="title01" style="font-size: 74px;">个性化设置</div>
                            <div class="text">
                                <!-- <div>新学年，新开始: 一起作业更换了别具寓意的新logo以及视觉形象，我们将带你进入一段充满惊喜的学习旅程……</div> -->
                                <div class="more">
                                   <!-- <a href="http://www.17zuoye.com/help/news/newscontent_27.vpage" target="_blank">查看更多</a> -->
                                </div>
                            </div>
                        ...
                        <div class="loginBtn clearfix">
                            <div class="zy-header" style="position: static; display: inline-block; width: auto; float: right; padding-left: 20px;">
                                <!-- <div class="rightIn" style="display: inline-block; float: none; margin: 0;padding: 0;">
                                    <a href="javascript:void(0);" target="_blank" class="load" style="padding: 0; border: none; float: none; width: auto; font-size: 16px; color: #000;">
                                       <i class="phone-icon"></i>APP下载
                                    </a>
                                </div> -->
                            </div>
                                <a href="javascript:;" class="JS-register-main">注册</a>
                     ...
                     <div class="info">
                        ...
                        <div class="title01" style="font-size: 64px">个性化设置</div>
            ...
            <li class="homeItem homeItem01" style="width: 100%">
                <div class="innerBox">
                    <div class="info">
                        <div class="title01" style="font-size: 74px;">教学诊断</div>
                        <div class="loginBtn clearfix">
                            <div class="zy-header" style="position: static; display: inline-block; width: auto; float: right; padding-left: 20px;">
<!--                                 <div class="rightIn" style="display: inline-block; float: none; margin: 0;padding: 0;">
                                    <a href="javascript:void(0);" target="_blank" class="load" style="padding: 0; border: none; float: none; width: auto; font-size: 16px; color: #000;"><i class="phone-icon"></i>APP下载</a>
...
<script  type='text/javascript' src='${ctxStatic }/modules/teacher/login/login.js' charset='utf-8'></script>
<c:if test="${ not empty message }">
<script type="text/javascript">
	$(".JS-login-main").trigger('click');
	baseErrorForgot('<p style="margin-top: -10px;">登录失败,${message}<br/><a href="javascript:void(0);"  class="info JS-forgetPassword-btn">忘记用户名/密码了？</a></p>');
	//基础错误提示
