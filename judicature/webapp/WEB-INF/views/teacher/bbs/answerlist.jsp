...
<sys:message content="${message}"/>
    <form:form id="searchForm" action="${ctx}/bbs/answerlist?question.id=${ques.id}" method="post" class="breadcrumb form-search">
		...
		<div class="control-group" >
			<p class="bg-wt">问题详情：</p>
           	<h2>${fns:replaceHtml(ques.detail)}
		...
		<input type="button"  id="addAnswerBtn" class="btn btn-default tbtn-primary" value="我来回答"  />
		<a href="${ctx}/bbs/queslist" class="btn  tbtn-primary">返回问题列表</a>
	</form:form>
	...
	<table  class="table table-striped table-bordered table-condensed table-tr" style="margin-left:50px;">
			<tr>
	...
	<div class="modal hide fade in" id="addAnswer" style="width: 400px; margin-left: -100px; top: 20%;"  >
		<form:form action="${ctx}/bbs/saveAnswerForm"  method="post" class="form-horizontal" id="addAnswerForm">
