...
<body>
						...
						<div class="problem" id="tm_1" index="1" topicid="2701"	style="width: 900px; display: block;">
							...
							<dl>
								...
								<c:if test="${not empty sMQuestion.choice0 }">
									<dd>
										<label for="tmda_1_0" id="tmxx_1_0" style="color: black;">
										<input type="checkbox" topicno="1" id="tmda_1_0" name="${sMQuestion.id}" value="A" > A:
								...
								<c:if test="${not empty sMQuestion.choice1 }">
									<dd>
										<label for="tmda_1_1" id="tmxx_1_1" style="color: black;">
										<input type="checkbox" topicno="1" id="tmda_1_1" name="${sMQuestion.id}" value="B" > B:
									...
									<dd>
										<label for="tmda_1_1" id="tmxx_1_1" style="color: black;">
										<input type="checkbox" topicno="1" id="tmda_1_1" name="${sMQuestion.id}" value="C" > C:
								...
								<c:if test="${not empty sMQuestion.choice3 }">
									<dd>
										<label for="tmda_1_1" id="tmxx_1_1" style="color: black;">
										<input type="checkbox" topicno="1" id="tmda_1_1" name="${sMQuestion.id}" value="D" > D:
								...
								<c:if test="${not empty sMQuestion.choice4 }">
									<dd>
										<label for="tmda_1_1" id="tmxx_1_1" style="color: black;">
										<input type="checkbox" topicno="1" id="tmda_1_1" name="${sMQuestion.id}" value="E" > E:
								...
								<c:if test="${not empty sMQuestion.choice5 }">
									<dd>
										<label for="tmda_1_1" id="tmxx_1_1" style="color: black;">
										<input type="checkbox" topicno="1" id="tmda_1_1" name="${sMQuestion.id}" value="F" > F:
								...
								<c:if test="${not empty sMQuestion.choice6 }">
									<dd>
										<label for="tmda_1_1" id="tmxx_1_1" style="color: black;">
										<input type="checkbox" topicno="1" id="tmda_1_1" name="${sMQuestion.id}" value="G" > G:
								...
								<c:if test="${not empty sMQuestion.choice7 }">
									<dd>
										<label for="tmda_1_1" id="tmxx_1_1" style="color: black;">
										<input type="checkbox" topicno="1" id="tmda_1_1" name="${sMQuestion.id}" value="H" > H:
								...
								<c:if test="${not empty sMQuestion.choice8 }">
									<dd>
										<label for="tmda_1_1" id="tmxx_1_1" style="color: black;">
										<input type="checkbox" topicno="1" id="tmda_1_1" name="${sMQuestion.id}" value="I" > I:
								...
								<c:if test="${not empty sMQuestion.choice9 }">
									<dd>
										<label for="tmda_1_1" id="tmxx_1_1" style="color: black;">
										<input type="checkbox" topicno="1" id="tmda_1_1" name="${sMQuestion.id}" value="J" > J:
					...
					<c:forEach items="${panduanQuestionList}" var="pdQuestion" varStatus="i" begin="0">
						<div class="problem" id="tm_1" index="1" topicid="2701"	style="width: 900px; display: block;">
							...
							<dl>
								...
								<dd>
									<button onclick="showExplain('${pdQuestion.id}')">讲解</button>
								</dd>
							</dl>
						</div>
					</c:forEach>
					...
					<c:forEach items="${gainianQuestionList}" var="gnQuestion" varStatus="i" begin="0">
						<div class="problem" id="tm_1" index="1" topicid="2701"	style="width: 900px; display: block;">
							...
							<dl>
								...
								<dd>
									<button onclick="showExplain('${gnQuestion.id}')">讲解</button>
								</dd>
							</dl>
						</div>
					</c:forEach>
					...
					<c:forEach items="${cQuestionList}" var="cQuestion" varStatus="i" begin="0">
						<div class="problem" id="tm_1" index="1" topicid="2701"	style="width: 900px; display: block;">
							...
							<dl>
								...
								<dd>
									<button onclick="showExplain('${cQuestion.id}')">讲解</button>
								</dd>
							</dl>
						</div>
					</c:forEach>
					...
					<c:forEach items="${zongheQuestionList}" var="zhQuestion" varStatus="i" begin="0">
						<div class="problem" id="tm_1" index="1" topicid="2701"	style="width: 900px; display: block;">
							...
							<dl>
								...
								<dd>
									<button onclick="showExplain('${zhQuestion.id}')">讲解</button>
								</dd>
							</dl>
						</div>
					</c:forEach>
					...
					<c:forEach items="${zhituQuestionList}" var="ztQuestion" varStatus="i" begin="0">
						<div class="problem" id="tm_1" index="1" topicid="2701"	style="width: 900px; display: block;">
							...
							<dl>
								...
								<dd>
									<button onclick="showExplain('${ztQuestion.id}')">讲解</button>
								</dd>
							</dl>
						</div>
					</c:forEach>
					...
					<c:forEach items="${zhibiaoQuestionList}" var="zbQuestion" varStatus="i" begin="0">
						<div class="problem" id="tm_1" index="1" topicid="2701"	style="width: 900px; display: block;">
							...
							<dl>
								...
								<dd>
									<button onclick="showExplain('${zbQuestion.id}')">讲解</button>
								</dd>
							</dl>
						</div>
					</c:forEach>
					...
					<c:forEach items="${shituQuestionList}" var="stQuestion" varStatus="i" begin="0">
						<div class="problem" id="tm_1" index="1" topicid="2701"	style="width: 900px; display: block;">
							...
							<dl>
								...
								<dd>
									<button onclick="showExplain('${stQuestion.id}')">讲解</button>
								</dd>
							</dl>
						</div>
					</c:forEach>
	...
	<input id="fh" type="button" class="btn sbtn-primary" style="margin-left: 20px;" onclick="javascript:history.back(-1)"  value="返回">
