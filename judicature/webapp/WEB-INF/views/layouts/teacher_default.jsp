	...
	<style type="text/css">
	  ...
	  /* .nav-tabs{font-weight:bold;} */
	   ...
	   /************************内容*******************************/
		...
		.main-content{height: 716px;}
		.main-content .main-left{background: #f9f9f9;width: 258px;float: left;overflow-y:auto;overflow-x:hidden;}
		.main-content .main-left .main-left-con{height: 716px;}
		...
		.main-left-con .navlist > li em{width: 14px;height: 7px;display: inline-block;background: url(${ctxStatic}/modules/teacher/img/click.png) no-repeat -1px -1px;float: right;margin: 32px 30px 0 0;}
		...
		.main-left-con .navlist > li.active em{background-position: -1px -9px;}
		...
		.main-content .content-right{/* width: 920px; */float: left;background: #fff;height: 690px;padding: 25px 17px 0;overflow-y:hidden;}
...
<%-- 
	...
	<div class="cour-content container clearfix">	
		...
		<%@include file="/WEB-INF/views/teacher/include/main_left.jsp" %>
