...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/qaa/uAnswer/">回答列表</a></li>
		<li class="active"><a href="${ctx}/qaa/uAnswer/form?id=${uAnswer.id}">回答<shiro:hasPermission name="qaa:uAnswer:edit">${not empty uAnswer.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="qaa:uAnswer:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="uAnswer" action="${ctx}/qaa/uAnswer/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
