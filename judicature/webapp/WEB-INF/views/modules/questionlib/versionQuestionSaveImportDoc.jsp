...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/questionlib/versionQuestion/importDoc?id=${versionQuestion.id}&extId=${extId}&courseQuestionlibId=${courseQuestionlibId}">导入试题文档</a></li>
	</ul><br/>
	<sys:message content="${message}"/>
		<form id="saveImportDocMessage" action="" method="post">
<%-- 		<form id="saveImportDocMessage" action="${ctx}/questionlib/versionQuestion/saveQuestionlibImport" method="post"> --%>
            ...
            <script type="text/javascript">
            	/* function saveImportMessage(){
            		$.ajax({
				         url:"${ctx}/questionlib/versionQuestion/saveQuestionlibImport",  
				         type:"post",  
				         data:$("#saveImportDocMessage").serialize(),  
				         dataType:"text",
				         success:function(data) { 
