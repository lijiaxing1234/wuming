...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="officeContent" src="${ctx}/questionlib/exam/list?schoolId=" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	<script type="text/javascript">
		function showQuestionlib(schoolId){
			$('#officeContent').attr("src","${ctx}/questionlib/exam/list?schoolId="+schoolId);
		}
		...
		function wSize(){
			...
			$('#officeContent').attr("src","${ctx}/questionlib/exam/list");
		}
	</script>
