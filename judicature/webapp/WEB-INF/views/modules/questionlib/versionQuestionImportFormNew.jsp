	...
	<%-- <sys:message content="${message}"/> --%>
		   <form id="saveImportDocMessage" action="${ctx}/questionlib/versionQuestion/importQuestionFileNew?courseId=${courseId}" method="post" enctype="multipart/form-data">
			<table style="margin: 0 auto;" id="importTable" >
				<tr>
					<th colspan="2" class="control-label"><h3>试题批量导入</h3></th>
				</tr>
				<tr>
				...
				<%-- <tr>
					...
					<td><input id ="writer" name="writer" type="text" value="${questionlibImport.writer }" class="input-medium required"  style="width:210px;"/><font style="color: red;">*</font></td>
				</tr> --%>
				...
				<%-- <tr>
					...
					title="学校" url="/sys/office/treeData?type=2" cssClass="input-medium required" allowClear="true" notAllowSelectParent="fasle"/><font style="color: red;">*</font>
					</td>
					<th></th>
					<td></td>
				</tr> --%>
				...
				<tr>
					...
					<td>
					    <span>
						   <input id="wordFile" name="wordFile" type="file" class="input-medium"  accept="*.doc,*.docx"  style="width:210px;"   class="input-medium required" />
						   <span class="help-inline"><font color="red">*</font>支持文件类型为 （*.doc）</span>
						</span>
					</td>
				</tr>
				<tr>
