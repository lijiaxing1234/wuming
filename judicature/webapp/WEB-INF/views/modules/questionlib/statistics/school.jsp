	...
	$(document).ready(function() {
		$("#btnExport").click(function(){
			 return confirmx("确认要导出吗？",function(){
					$("#searchForm").attr("action","${ctx }/questionlib/statistics/schoolExport");
					$("#searchForm").submit(); 
				});
			});
		$("#btnSubmit").click(function(){
					$("#searchForm").attr("action","${ctx}/questionlib/statistics/school");
					$("#searchForm").submit(); 
			});
		});
		function page(n,s){
...
<body>
	...
	<form:form id="searchForm" modelAttribute="school" action="${ctx}/questionlib/statistics/school" method="post" class="breadcrumb form-search">
		...
		<li>
			...
			<label>学校：</label>
		    <form:select path="id"  cssStyle="width:350px">
		...
		<shiro:hasPermission name="questionlib:statistics:school:export">
		<li class="btns">
		<input id="btnExport" class="btn btn-primary" type="button" value="导出"/>
		<%-- <a class="btn btn-primary" href="${ctx }/questionlib/statistics/schoolExport">导出</a> --%></li>
		</shiro:hasPermission>
