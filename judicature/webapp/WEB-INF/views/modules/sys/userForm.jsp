...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<%-- <form:input path="phone" htmlEscape="false" maxlength="11" minlength="11" class="input-xlarge digits"/> --%>
				<form:input path="phone" htmlEscape="false" maxlength="11" minlength="11" class="digits"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">手机:</label>
			<div class="controls">
				<form:input path="mobile" htmlEscape="false" maxlength="11" minlength="11" class="digits"/>
			</div>
		</div>
		<div class="control-group">
