	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><img  style="margin-top: 0px;" src="${ctxStatic }/images/logo/s_logo.png"><span id="productName">${fns:getConfig('productName')}</span></div>
