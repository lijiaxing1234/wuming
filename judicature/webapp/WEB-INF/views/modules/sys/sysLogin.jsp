...
<head>
	...
	<script type="text/javascript" src="${ctxStatic }/modules/sys/login/js/jquery-1.7.2.min.js"></script>
	...
	<script src="${ctxStatic}/modules/sys/js/main.js" type="text/javascript"></script>
	
	
	<link rel='stylesheet' type='text/css' charset='utf-8'  href='${ctxStatic }/modules/sys/login/css/jquery-impromptu.css' />
	<link rel='stylesheet' type='text/css' charset='utf-8'  href='${ctxStatic }/modules/sys/login/css/demo.css' />
	
	<script type="text/javascript" src="${ctxStatic }/modules/sys/login/js/common.js"></script>
	
    <script  type='text/javascript' src='${ctxStatic }/modules/sys/login/js/template.js' charset='utf-8'></script>
    <script  type='text/javascript' src='${ctxStatic }/modules/sys/login/js/jquery.flexslider.js' charset='utf-8'></script>
	<!--[if IE 6]>
	  <script  type='text/javascript' src='${ctxStatic }/modules/sys/login/js/DD_belatedPNG.js' charset='utf-8'></script> 
    ...
    <div class="JS-indexSwitch-main">
        <ul class="zy-homeBox slides">
            <li class="homeItem homeItem01">
                <div class="innerBox">
                    <div class="info">
                        <div class="title01" style="font-size: 74px">职考通管理平台</div>
...
<script type="text/html" id="T:LoginTemplateMain">
        ...
        <div class="lop-inner">
            ...
            <h1>登录</h1>
                <form id="sys/" class="JS-formSubmit" method="post" action="${ctx}/login">
                    <input name="returnURL" type="hidden" value=''>
                    <div class="lop-content">
                        <div class="c-text">
                            <span class="login-icon icon-5"></span>
                            <input type="text" value="${loginName}" name="username" tabIndex="1"
...
<script  type='text/javascript' src='${ctxStatic }/modules/sys/login/login.js' charset='utf-8'></script>
