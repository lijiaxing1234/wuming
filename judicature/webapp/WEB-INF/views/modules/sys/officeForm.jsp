...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/office/list?extId=${extId}">机构列表</a></li>
		<li class="active"><a href="${ctx}/sys/office/form?extId=${extId}">机构<shiro:hasPermission name="sys:office:edit">${not empty office.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:office:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save?extId=${extId}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="office" name="parent.id" value="${office.parent.id}" labelName="parent.name" labelValue="${office.parent.name}"
					...
					<span class="help-inline">上级机构为空表示的是根节点</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">机构顺序:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">“是”代表此机构和该下部门允许登录，“否”则表示此机构和该下部门不允许登录</span>
			</div>
		</div> 
		<div class="control-group" style="display: none">
