...
<body>
	...
	<div id="importForm" style="width: 100%;height: 100%;position: absolute; top: 0;display: none;">
		...
		<form id="saveImportDocMessage" action="${ctx}/school/schoolversionQuestion/saveQuestionlibImport?courseQuestionlibId=${courseQuestionlibId}" method="post">
			<table style="margin: 0 auto;" id="importTable">
				...
				<tr>
					...
					<td>
						...
						title="专业" url="/school/schoolspecialty/treeData" cssClass="input-medium" notAllowSelectParent="true" />
			...
			<script type="text/javascript">
				function add(){
					 ...
					 if(isSelectDoc==0){
						...
						/*  $("#saveImportDocMessage").post("${ctx}/school/schoolversionQuestion/saveQuestionlibImport",{"courseQuestionlibId":$("#questionlibId").val()},function(data){
						 ...
						 alert(importDataId);
						 var returnstr = MyActiveX.FunSendWord("127.0.0.1",8080,"${ctx}/school/schoolversionQuestion/importQuestionFile?importDataId="+importDataId);//发送包含上传的word和保存图片的压缩文件
						 alert(returnstr);
						 $.ajax({
		    ...
		    <form action="${ctx}/school/schoolversionQuestion/importQuestionFile" method="post" enctype="multipart/form-data">
