...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/school/shoolUser/info">个人信息</a></li>
		<li><a href="${ctx}/school/shoolUser/modifyPwd">修改密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/school/shoolUser/info" method="post" class="form-horizontal"><%--
