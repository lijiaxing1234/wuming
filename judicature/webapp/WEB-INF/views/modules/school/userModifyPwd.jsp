...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/school/schoolUser/info">个人信息</a></li>
		<li class="active"><a href="${ctx}/school/schoolUser/modifyPwd">修改密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/school/schoolUser/modifyPwd" method="post" class="form-horizontal">
		<form:hidden path="id"/>
