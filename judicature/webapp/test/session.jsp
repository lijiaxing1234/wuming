...
<%@ page import="com.thinkgem.jeesite.modules.student.utils.OnlineStudentUtils" %>
<html>
<head>
...
<hr>
<%
	Vector<OnlineStudentUtils.Subject> vector=OnlineStudentUtils.getIntance().getVector();
	
    for(OnlineStudentUtils.Subject obj:vector){
    	out.println("学生端session："+obj);
    }
%>		
</body>
</html>