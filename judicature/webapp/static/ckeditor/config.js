...
CKEDITOR.editorConfig = function( config ) {
	...
	config.toolbar_default = [
		['Source','-','Image','Undo','Redo','SpecialChar','Table','Bold','Italic','Underline','Strike','TextColor','BGColor','Undo','Redo','Copy','Paste','Subscript','Superscript','JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock','Format' ,'PasteFromWord']//,
