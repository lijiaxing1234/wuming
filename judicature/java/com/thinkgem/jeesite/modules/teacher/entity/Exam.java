...
public class Exam extends DataEntity<Exam>{
	...
	private String examHours; //随堂练习的用时、考点学时
	...
	public Exam(String title, String examType, String teacherId, String versionId, String examPlace, Date beginTime,
			Date endTime, Date publishAnswerTime, String examHours, String endHours, String answerHours, String isab,
			String total_score, String level, Date time, TableClass examClass, Course examCourse, String status,
			String isNew, String examMode, Integer totalPerson, Integer unSubmitPerson, String isTeacher,
			String istemplate, String useTemplatId, String ranking) {
		super();
		this.title = title;
		this.examType = examType;
		this.teacherId = teacherId;
