 ...
 */
package com.thinkgem.jeesite.modules.web.util.mtcloud;
...
public class MTCloud {
	...
	Logger  logger=LoggerFactory.getLogger(MTCloud.class);
	    
	    /**
	     * 合作方ID： 合作方在欢拓平台的唯一ID
	     */
	    public String openID = "11554";
	    
	    /**
	     * 合作方秘钥： 合作方ID对应的参数加密秘钥
	     */
	    public String openToken = "e4ecbdcf4baca0b2b020c4d9225b2496";
	     ...
	     * SDK版本号(请勿修改)
	     */
	    public String version = "java.1.3";
	     ...
	     * @throws Exception
	     */
	    public String roomCreate(String roomName,int voiceFlow,String authKey) throws Exception {
	    	HashMap<Object,Object> params = new HashMap<Object,Object>();
	    	params.put("roomName",roomName);
	     ...
	     * 获取主播信息
	     * @param String account 主播账号
	     * @param int accountType 主播账号类型 	(如果是欢拓的账号类型，account可以为空)
	     * @return
	     * @throws Exception
	     */
	    public String zhuboGet(String account,Integer accountType) throws Exception {
	    	HashMap<Object,Object> params = new HashMap<Object,Object>();
	    	params.put("account", account);
	    	params.put("accountType", accountType);
	     ...
	     * @throws Exception
	     */
	    public String liveStreamAddress(String liveid, HashMap<Object,Object> options) throws Exception {
	    	HashMap<Object,Object> params = new HashMap<Object,Object>();
	    	params.put("liveid", liveid);
	    	params.put("options", options);
        ...
        *   @param String course_id 课程ID
        */
        public String courseGet(String course_id) throws Exception {
            HashMap<Object,Object> params = new HashMap<Object,Object>();
            params.put("course_id", course_id);
        ...
        */
        public String courseUpdate(String course_id, String account, String course_name, String start_time, String end_time, String nickname, String accountIntro) throws Exception {
            HashMap<Object,Object> params = new HashMap<Object,Object>();
            params.put("course_id", course_id);
            params.put("course_name", course_name);
            params.put("account", account);
         ...
         *  @return
         */
        public String courseVoteList(String course_id, int page, int size) throws Exception {
            HashMap<Object,Object> params = new HashMap<Object,Object>();
            params.put("course_id", course_id);
            params.put("page", page);
            params.put("size", size);
         ...
         */
        public String courseRobotSet(int course_id, ArrayList userList) throws Exception {
        	HashMap<Object,Object> params = new HashMap<Object,Object>();
        	params.put("course_id", course_id);
        	params.put("userList", userList);
         ...
         * @param HashMap 	options 		可选参数
         */
        public String courseStreamAddress(int course_id, HashMap<Object,Object> options) throws Exception {
        	HashMap<Object,Object> params = new HashMap<Object,Object>();
        	params.put("course_id", course_id);
        	params.put("options", options);
         ...
         * @throws Exception
         */
        public String videoUpload(String fileName, String account, int accountType, String title, String nickname, String accountIntro) throws Exception {
        	String retval = "";
        	String fileMd5 = "";
         ...
         * @throws Exception
         */
//        public String videoSegmentUpload(String fileName, String account, int accountType, String title, String nickname, String accountIntro) throws Exception {
//        	
//        }
		...
		public String doGet(String url) throws UnsupportedEncodingException {			
			...
			try {
				client.executeMethod(method);		//执行		
				 ...
				 responseContent=method.getResponseBody(); 
				 
				
					
			/*	
			   logger.warn(new String(responseContent,"UTF-8"));
			   InputStream jsonStr;
			   ...
			   ByteArrayOutputStream   baos   =   new   ByteArrayOutputStream(); 
				...
				BufferedReader br = new BufferedReader(new InputStreamReader(jsonStr,"UTF-8"));   
			...
			if (responseContent != null && responseContent.length>0) {
				...
				return new String(responseContent,"UTF-8");
			}
		    return null;
		}
