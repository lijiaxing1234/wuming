 ...
 *//*
@Controller
@RequestMapping(value = "/questionlib/messageStudent")
public class MessageStudentController extends BaseController {
	...
	@RequiresPermissions("questionlib:messageStudent:view")
	...
	public String form(MessageStudent messageStudent, Model model) {
		...
		return "modules/questionlib/messageStudentForm";
	}
    
	@RequiresPermissions("questionlib:messageStudent:edit")
	...
	public String save(MessageStudent messageStudent, Model model, RedirectAttributes redirectAttributes,HttpServletRequest request) {
		...
		if(StringUtils.isNotBlank(param)){
			...
			return "modules/questionlib/messageStudentTip";
		}else{
